                ...
                return (
                  <li
                    className={cn(
                      ...
                      selectedTab === path
                        ? "bg-gradient-to-r from-[#111329a3] via-[#0321237a] to-transparent transition-colors duration-1000 ease-in-out"
                        : "",
                    )}
                    key={id}
                  >
                    <motion.div
                      ...
                      className={cn(
                        selectedTab === path
                          ? "bg-cyan-200/50] absolute left-[-5px] top-0 z-[2] block h-full w-2 border border-[#00b7ff]"
                          : "",
                      )}
                    />
                    {focused === label ? (
